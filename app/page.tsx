...
import LiquidEther from './components/etherbg';
...
export default function Home() {
  return (
    ...
    <div className="bg-gray-900 min-h-screen w-screen relative isolate overflow-hidden">
      ...
      <div
        aria-hidden="false"
        className="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden sm:-top-80 w-screen h-screen"
      >
        <LiquidEther className="absolute inset-0 w-screen h-screen" />
      </div>
